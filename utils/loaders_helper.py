...
def load_docs_with_sdr(documents_folder):
    documents = SimpleDirectoryReader(documents_folder, recursive=True, required_exts=['.md'], file_metadata=filename_to_metadata).load_data()
